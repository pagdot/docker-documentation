...
<!-- Please read https://github.com/linuxserver/docker-mysql-workbench/blob/master/.github/CONTRIBUTING.md -->
...
| Parameter | Function |
| :----: | --- |
| `3000:3000` | Mysql Workbench desktop gui HTTP, must be proxied. |

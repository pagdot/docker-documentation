...
<!-- Please read https://github.com/linuxserver/docker-mullvad-browser/blob/main/.github/CONTRIBUTING.md -->
# [linuxserver/mullvad-browser](https://github.com/linuxserver/docker-mullvad-browser)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fmullvad-browser?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
...
* Update images:
    ...
    * Single image:
        ...
        ```bash
        docker-compose pull mullvad-browser
        ```
...
* Update containers:
    ...
    * Single container:
        ...
        ```bash
        docker-compose up -d mullvad-browser
        ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/mullvad-browser:latest
    ```

* Stop the running container:

    ```bash
    docker stop mullvad-browser
    ```

* Delete the container:

    ```bash
    docker rm mullvad-browser
    ```

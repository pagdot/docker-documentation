...
tags:
    - Content Management
description: "[HedgeDoc](https://hedgedoc.org/) gives you access to all your files wherever you are.
...
<!-- Please read https://github.com/linuxserver/docker-hedgedoc/blob/main/.github/CONTRIBUTING.md -->
